      ...
      {isLoading && (
        ...
        >
          ...
          <motion.div 
            ...
            className="relative text-2xl md:text-5xl font-black tracking-widest px-4 text-center"
          >
            ...
            <motion.div 
              className="absolute top-0 left-0 w-full text-white overflow-hidden whitespace-nowrap font-sans uppercase drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]"
